...
public class ModBlocks {
    ...
    // public static final BlockEntry<ShaftBlock> SMALL_STEEL_PIPE =
    // REGISTRATE.block("small_steel_pipe", ShaftBlock::new)
    ...
    // .simpleItem()
    // .register();
    // public static final BlockEntry<ShaftBlock> SMALL_IRON_PIPE =
    // REGISTRATE.block("small_iron_pipe", ShaftBlock::new)
    // .properties(p -> p.color(MaterialColor.METAL).strength(0.2F))
    // .transform(BlockStressDefaults.setNoImpact())
    // .transform(pickaxeOnly())
    // .blockstate(BlockStateGen.axisBlockProvider(false))
