...
public class Validator {
    /**
     * Validates that the deserialized object's required fields are not null. This
     * is an abstracted
     ...
     * @throws IllegalAccessException if it's unable to access a field. This should
     *                                never happen
    ...
    public static <T> boolean isValidObject(T t) throws IllegalAccessException, InvalidObjectException {
        ...
        for (Field field : fields) {
            ...
            if (field.get(t) == null) {
                throw new InvalidObjectException("Missing required property: ".concat(field.getName()));
            }
